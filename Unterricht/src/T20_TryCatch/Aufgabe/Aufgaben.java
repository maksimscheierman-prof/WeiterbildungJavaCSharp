 ...
 *                  - static int anzahlGürtel   // Soll für jeden erstellten Gürtel eins hochzählen.
 *              d) Die Klasse soll folgende Methoden haben:
 *                  - generateBelt(int length, int holes){}
 *                  -   Die Methode soll eine IOException ausgeben wenn die länge des Gürtels kleiner 60 ist,
